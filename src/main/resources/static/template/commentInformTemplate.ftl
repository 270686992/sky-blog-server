...
<html lang="en">
    ...
    <body>
        <div style="background-color: #eee; padding-top: 5px;">
            <h2 style="text-align: center; margin: 5px auto; color: #337ab7;">有游客评论啦~~~</h2>
            ...
            <div style="padding: 0;">
                <div style="padding-left: 5px;">
                    <p>
                        有游客在 <a href="https://www.xilikeli.cn">博击长空</a> WEB 站点中留下了评论,内容如下:
                    </p>
                    ...
                    <p>
                        访问: <a href="${articleUrl}">${articleUrl}</a> 查看。
                    </p>
                </div>
